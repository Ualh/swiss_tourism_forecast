...
table_vaud <- reactable(head(tourism_vaud, 1000), 
          searchable = TRUE,
          defaultPageSize = 5,
          sortable = TRUE,
          filterable = TRUE,
...
interactive_plot <- ggplotly(plot_vaud, tooltip = "text", width = 700, height = 300)
...
# Convert to an interactive plotly object with specified width and height
interactive_plot_total <- ggplotly(plot_vaud_total, width = 700, height = 300)
...
*see the appendix for a vizualisation of the 3 models*
...
*See the appendix for a vizualisation of the stringency index for the Philippines and Switzerland*
